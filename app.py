...
def extract_skills(resume_text):
    """
    Extract skills from resume text without using skills.csv
    """

    skills_list = [
        "Python", "SQL", "ReactJS", "PeopleSoft", "Workday",
        "Oracle", "AWS", "Power BI", "Tableau", "Java",
        "JavaScript", "HTML", "CSS", "Machine Learning",
        "Data Analysis", "Excel", "ETL", "Data Warehouse",
        "PeopleTools", "Application Engine", "Component Interface",
        "SQR", "PeopleCode", "Workday HCM", "Workday Studio",
        "Core Java", "Spring Boot", "MySQL", "MongoDB",
        "Git", "GitHub", "Linux"
    ]
